...
#importing files
total_lsl_trial <- 24
# TO DO: Check these keys against An's mturk ones. Checked so far for lsl, but should check for other conds.
...
for (i in seq(from=1,to=length(lsl_accuracy$cond),by=32)){
