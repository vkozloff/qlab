...
# TO DO: Check on this
# TO DO: Manually find RT slope, mean RT, and accuracy for a few participants to make sure this is working
...
for (i in seq(from=1,to=length(vsl_accuracy$cond),by=32)){
  vsl_cond<-append(vsl_cond,as.character(vsl_accuracy[i,]$cond))
  }
